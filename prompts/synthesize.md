...
- **Promoted to CLAUDE.md** — the observation describes a stated, always-on preference that doesn't need situation-specific triggering. Short rules, not workflows.
...
- Do **not** propose duplicates of what's already in CLAUDE.md or existing skills (you don't have visibility into those — be conservative).
- Each observation can have at most one proposal. Pick the better fit of skill vs. CLAUDE.md.
